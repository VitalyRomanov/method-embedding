...
import numpy as np
from SourceCodeTools.graph.model.train.utils import create_idx_pools, evaluate_no_classes
...
def train(MODEL_BASE, model, g_labels, splits, epochs, lr):
    """
...
def training_procedure(dataset, model, params, EPOCHS, args, MODEL_BASE):
    ...
    try:
        train(MODEL_BASE, m, labels, dataset.splits, EPOCHS, lr)
