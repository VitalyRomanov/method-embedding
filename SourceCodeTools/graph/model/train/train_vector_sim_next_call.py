...
def train_no_classes(MODEL_BASE, model, elem_embeder, link_predictor, splits, epochs):
...
def training_procedure(dataset, model, params, EPOCHS, call_seq_file, restore_state, MODEL_BASE):
    NODE_EMB_SIZE = 100
    ELEM_EMB_SIZE = 100
    ...
    try:
        train_no_classes(MODEL_BASE, m, ee, lp, dataset.splits, EPOCHS)
