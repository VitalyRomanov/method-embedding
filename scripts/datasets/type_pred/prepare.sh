...
# Script for preparing a dedicated type prediction dataset

python $RUN_DIR/../../../SourceCodeTools/code/data/type_annotation_dataset/type_prediciton_dataset_creator.py $ENVIRONMENTS_PATH $OUTPUT_PATH --track_offsets --bpe_tokenizer $BPE_TOKENIZER &&
