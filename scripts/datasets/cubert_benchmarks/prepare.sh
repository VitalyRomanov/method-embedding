...
python "$RUN_DIR/../../../SourceCodeTools/code/data/cubert_python_benchmarks/cubert_python_benchmarks.py" $CUBERT_DATA_PATH/variable_misuse.json $CUBERT_DATA_PATH/variable_misuse_with_spans.json
