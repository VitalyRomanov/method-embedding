...
python "$RUN_DIR/../../../SourceCodeTools/code/data/cubert_python_benchmarks/convert_for_ast_graph_builder.py" $CUBERT_DATA_PATH/variable_misuse_with_spans.json $CUBERT_DATA_PATH/variable_misuse.csv &&
