...
def training_procedure(dataset, model, params, EPOCHS, api_seq_file, fname_file, var_use_file, restore_state):
    NODE_EMB_SIZE = 100
    ELEM_EMB_SIZE = 100
    ...
    try:
        train(m, ee_fname, ee_varuse, ee_apicall, lp_fname, lp_varuse, lp_apicall, dataset.splits, EPOCHS)
