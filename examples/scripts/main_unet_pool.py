...
save_config(config, "unet_pooling_var_misuse_subgraph.yaml")
...
from SourceCodeTools.models.graph.train.objectives.SubgraphClassifierObjective import SubgraphAbstractObjective, \
    SubgraphClassifierObjective, SubgraphEmbeddingObjective, SubgraphClassifierObjectiveWithUnetPool
    ...
    def create_objectives(self, dataset, tokenizer_path):
        ...
        self.objectives.append(
            self._create_subgraph_objective(
                objective_name="VariableMisuseClfWithUnetPool",
